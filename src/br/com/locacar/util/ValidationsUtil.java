...
/**
 * Classe responsável por validar CPF's, CNPJ's e E-mail's!
 * @author Felipe Nascimento
 */
public class ValidationsUtil {
	private static final Logger LOG = LogManager.getLogger(ValidationsUtil.class.getName());
	...
	public static boolean validaCpf(String cpf) {
        ...
        try {
        	...
        	LOG.error("O valor informado é inválido! Exception: {}", e.getMessage());
			JOptionPane.showMessageDialog(null, new MensagensModel(Bundle.getString("valorInvalido")).getText(), "AVISO", JOptionPane.WARNING_MESSAGE);
			return (false);
        }
	}
